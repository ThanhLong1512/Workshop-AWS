...
In this step, we will proceed to create IAM Role. In this IAM Role, the policy **WebsiteKMSPolicy** will be assigned, this is the policy that allows the EC2 server to communicate with the Session Manager.
